...
function getProperties(_values, defaultProperties /* , target: Platform*/) {
  ...
  */
  var source = _values.source;
  source === "fileDocument" ? dist.hidePropertiesIn(defaultProperties, _values, ["url", "src"]) : dist.hidePropertyIn(defaultProperties, _values, "file");
  return defaultProperties;
}
// export function check(_values: IframeElementPreviewProps): Problem[] {
...
//     return errors;
// }
// export function getPreview(values: IframeElementPreviewProps, isDarkMode: boolean, version: number[]): PreviewProps {
...
//     }
// }
// export function getCustomCaption(values: IframeElementPreviewProps, platform: Platform): string {
